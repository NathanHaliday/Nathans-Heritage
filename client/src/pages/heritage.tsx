...
const sections = [
  ...
  },
  {
    ...
    content: `I am from New Zealand, a country celebrated for its rich Māori culture, stunning landscapes, and The Lord of the Rings movies. The Waikato River, New Zealand's longest river, flows through my homeland, holding great spiritual and cultural importance for the local Māori tribes. I currently live in Pōkeno, a town with a rich history.`,
